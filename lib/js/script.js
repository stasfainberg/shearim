...
const headdd = table.getElementsByTagName("thead");
const headddtt = headdd[0];
const hhh = headddtt.getElementsByTagName("tr");
const ccc = hhh[0].getElementsByTagName("th");
const vvv = ccc[6].getElementsByTagName("ul");


console.log(table);
console.log(headdd);
console.log(headdd[0]);
console.log(headddtt);
console.log(hhh);
console.log(hhh[0]);
console.log(ccc);
console.log(ccc[6]);
  ...
  function displayData() {
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      if(cursor) {
        ...
        let filterListListItem = document.createElement('li');

        //Create anchor item for filter list
        let filterListAnchor = document.createElement('a');
        filterListAnchor.innerText = cursor.value.clientName;

        //Inseart a in to li for filter
        filterListListItem.appendChild(filterListAnchor);

        //Inseart li with all data in to dropdown filter list
        vvv[0].appendChild(filterListListItem);
