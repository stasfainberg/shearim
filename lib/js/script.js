  ...
  function displayData() {
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      if(cursor) {
        ...
        //create href attribute in each <a> element
        filterListAnchorClientName.setAttribute("href", "filterByClientName");
        filterListAnchorInvoiceNumber.setAttribute("href", "filterByInvoiceNumber");
        filterListAnchorPaymentMethod.setAttribute("href", "filterByPaymentMethod");
        filterListAnchorPaiedBy.setAttribute("href", "filterByPaiedBy");
        filterListAnchorDate.setAttribute("href", "filterByDate");
        filterListAnchorAmount.setAttribute("href", "filterByAmount");
