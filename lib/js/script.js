...
*/
  ...
  function displayData() {
    ...
    while (tbody.firstChild) {
      ...
      filterListClientArray.pop();
      filterListInvoiceArray.pop();
      filterListPaymentMethodArray.pop();
      filterListPaiedByArray.pop();
      filterListDateArray.pop();
      filterListAmountArray.pop();
    }

    console.log("filters");
    console.log(filterListClient);    
    console.log(filterListInvoice);    
    console.log(filterListPaymentMethod);    
    console.log(filterListPaiedBy);    
    console.log(filterListDate);    
    console.log(filterListAmount);    



    filterElementCount = 0;
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      console.log("openCursor onSuccess");
      ...
      if(cursor) {
        ...
        console.log("anchor was created");

        //create onclick attribute in each <a> element
        filterListAnchorClientName.setAttribute("onclick", "filterByClientName()");
        filterListAnchorInvoiceNumber.setAttribute("onclick", "filterByInvoiceNumber()");
        filterListAnchorPaymentMethod.setAttribute("onclick", "filterByPaymentMethod()");
        filterListAnchorPaiedBy.setAttribute("onclick", "filterByPaiedBy()");
        filterListAnchorDate.setAttribute("onclick", "filterByDate()");
        filterListAnchorAmount.setAttribute("onclick", "filterByAmount()");

        console.log("onclick attribute was added");

        //create id attribute in each <a> element
        filterListAnchorClientName.setAttribute("id", "filterByClientName" + filterElementCount++);
        filterListAnchorInvoiceNumber.setAttribute("id", "filterByInvoiceNumber" + filterElementCount++);
        filterListAnchorPaymentMethod.setAttribute("id", "filterByPaymentMethod" + filterElementCount++);
        filterListAnchorPaiedBy.setAttribute("id", "filterByPaiedBy" + filterElementCount++);
        filterListAnchorDate.setAttribute("id", "filterByDate" + filterElementCount++);
        filterListAnchorAmount.setAttribute("id", "filterByAmount" + filterElementCount++);

        console.log("id attribute was added");
        ...
        console.log("filterListClientArray");
        console.log(filterListClientArray);

        console.log("cursor.value.clientName");
        console.log(cursor.value.clientName);

        console.log("filterListAnchorClientName");
        console.log(filterListAnchorClientName);



        //add client to filter dropdown
        if(filterListClientArray.includes(cursor.value.clientName))
        {
          ...
          filterListClientArray.push(cursor.value.clientName);
          filterListAnchorClientName.innerText = cursor.value.clientName;
          console.log(cursor.value.clientName + " added to array");

        };


        console.log("filterListInvoiceArray");
        console.log(filterListInvoiceArray);

        console.log("cursor.value.invoiceNumber");
        console.log(cursor.value.invoiceNumber);

        console.log("filterListAnchorInvoiceNumber");
        console.log(filterListAnchorInvoiceNumber);

        //add invoice to filter dropdown
        if(filterListInvoiceArray.includes(cursor.value.invoiceNumber))
        {
          console.log("in array");
          console.log("filterListInvoiceArray");
          console.log(filterListInvoiceArray);
          ...
          filterListInvoiceArray.push(cursor.value.invoiceNumber);
          filterListAnchorInvoiceNumber.innerText = cursor.value.invoiceNumber;
          console.log(cursor.value.invoiceNumber + " added to array");

        };

        console.log("filterListPaymentMethodArray");
        console.log(filterListPaymentMethodArray);

        console.log("cursor.value.paymentMethod");
        console.log(cursor.value.paymentMethod);

        console.log("filterListAnchorPaymentMethod");
        console.log(filterListAnchorPaymentMethod);

        //add payment method to filter dropdown
        if(filterListPaymentMethodArray.includes(cursor.value.paymentMethod))
        {
          console.log("in array");
          console.log("filterListPaymentMethodArray");
          console.log(filterListPaymentMethodArray);
          ...
          filterListPaymentMethodArray.push(cursor.value.paymentMethod);
          filterListAnchorPaymentMethod.innerText = cursor.value.paymentMethod;
          console.log(cursor.value.paymentMethod + " added to array");

        };

        console.log("filterListPaiedByArray");
        console.log(filterListPaiedByArray);

        console.log("cursor.value.paiedBy");
        console.log(cursor.value.paiedBy);

        console.log("filterListAnchorPaiedBy");
        console.log(filterListAnchorPaiedBy);

        //add paied by to filter dropdown
        if(filterListPaiedByArray.includes(cursor.value.paiedBy))
        {
          console.log("in array");
          console.log("filterListPaiedByArray");
          console.log(filterListPaiedByArray);
          ...
          filterListPaiedByArray.push(cursor.value.paiedBy);
          filterListAnchorPaiedBy.innerText = cursor.value.paiedBy;
          console.log(cursor.value.paiedBy + " added to array");

        };

        console.log("filterListDateArray");
        console.log(filterListDateArray);

        console.log("cursor.value.date");
        console.log(cursor.value.date);

        console.log("filterListAnchorDate");
        console.log(filterListAnchorDate);

        //add date by to filter dropdown
        if(filterListDateArray.includes(cursor.value.date))
        {
          console.log("in array");
          console.log("filterListDateArray");
          console.log(filterListDateArray);
          ...
          filterListDateArray.push(cursor.value.date);
          filterListAnchorDate.innerText = cursor.value.date;
          console.log(cursor.value.date + " added to array");

        };

        console.log("filterListAmountArray");
        console.log(filterListAmountArray);

        console.log("cursor.value.amount");
        console.log(cursor.value.amount);

        console.log("filterListAnchorAmount");
        console.log(filterListAnchorAmount);

        //add amount to filter dropdown
        if(filterListAmountArray.includes(cursor.value.amount))
        {
          console.log("in array");
          console.log("filterListAmountArray");
          console.log(filterListAmountArray);
          ...
          console.log("not in array");
          filterListAmountArray.push(cursor.value.amount);
          filterListAnchorAmount.innerText = cursor.value.amount;
          console.log(cursor.value.amount + " added to array");
        };


        console.log("filterListAnchorClientName");
        console.log(filterListAnchorClientName);
        console.log("filterListListItemClientName");
        console.log(filterListListItemClientName);
        ...
        console.log("a insearted into li");
        ...
        console.log("li insearted in to filter");
...
/*
        filterListClientArray = [];
        filterListInvoiceArray = [];
        filterListPaymentMethodArray = [];
        filterListPaiedByArray = [];
        filterListDateArray = [];
        filterListAmountArray = [];
*/
