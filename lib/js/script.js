...
const tableHeadFirstRowTr = tableHeadFirstRow.getElementsByTagName("th");
const tableHeadFirstRowTrUlElement = tableHeadFirstRowTr[6].getElementsByTagName("ul");
  ...
  function displayData() {
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      if(cursor) {
        ...
        tableHeadFirstRowTrUlElement[0].appendChild(filterListListItem);
