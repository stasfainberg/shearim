...
const tableHeadFirstRowTrUlElementAmount = tableHeadFirstRowTh[1].getElementsByTagName("ul");
const tableHeadFirstRowTrUlElementDate = tableHeadFirstRowTh[2].getElementsByTagName("ul");
const tableHeadFirstRowTrUlElementPaiedBy = tableHeadFirstRowTh[3].getElementsByTagName("ul");
const tableHeadFirstRowTrUlElementPaymentMethod = tableHeadFirstRowTh[4].getElementsByTagName("ul");
const tableHeadFirstRowTrUlElementInvoiceNumber = tableHeadFirstRowTh[5].getElementsByTagName("ul");
const tableHeadFirstRowTrUlElementClientName = tableHeadFirstRowTh[6].getElementsByTagName("ul");


const filterListClient = document.getElementById("filterListClient");
const filterListInvoice = document.getElementById("filterListInvoice");
const filterListPaymentMethod = document.getElementById("filterListPaymentMethod");
const filterListPaiedBy = document.getElementById("filterListPaiedBy");
const filterListDate = document.getElementById("filterListDate");
const filterListAmount = document.getElementById("filterListAmount");
  ...
  function displayData() {
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      if(cursor) {
        ...
        filterListAnchorInvoiceNumber = cursor.value.invoiceNumber;
        filterListAnchorPaymentMethod = cursor.value.paymentMethod;
        filterListAnchorPaiedBy = cursor.value.paiedBy;
        filterListAnchorDate = cursor.value.data;
        filterListAnchorAmount = cursor.value.amount;
