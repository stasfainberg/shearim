...
*/
  ...
  function displayData() {
    ...
    objectStore.openCursor().onsuccess = function(e) {
      ...
      if(cursor) {
        ...
        filterListAnchorClientName.setAttribute("href", "javascript:filterByClientName(this.id)");
        filterListAnchorInvoiceNumber.setAttribute("href", "javascript:filterByInvoiceNumber(this.id)");
        filterListAnchorPaymentMethod.setAttribute("href", "javascript:filterByPaymentMethod(this.id)");
        filterListAnchorPaiedBy.setAttribute("href", "javascript:filterByPaiedBy(this.id)");
        filterListAnchorDate.setAttribute("href", "javascript:filterByDate(this.id)");
        filterListAnchorAmount.setAttribute("href", "javascript:filterByAmount(this.id)");
  ...
  function deleteAllData(e){
    ...
    var result = confirm("האם בטוח למחוק את כל המידע?");
    if (result) 
    {
